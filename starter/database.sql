...
`D` varchar(255) default null,DROP SCHEMA IF EXISTS `edukademiks`;
CREATE SCHEMA `edukademiks`;
USE `edukademiks`;
...
INSERT INTO `Subject`(`name`, `question`, `question_number`,`exam_year`, `course_category`,`answer`) values(
'Physics', 'The following is a property of electromagnetic waves',3, str_to_date('01-02-2003', '%m-%d-%Y'), 1, 'short wavelength');
...
Insert into `Options`(`A`,`B`, `C`, `D`, `E`, `subject_id`) values('6 sides', '12 sides', '4 sides', '13 sides', 'None of the above',2);
...
Insert into `Options`(`A`,`B`, `C`, `D`, `E`, `subject_id`) values('short wavelength', 'Long wavelength', 'Low penetrating power', 'Refactive index', 'Critical angle of refractive',7);
